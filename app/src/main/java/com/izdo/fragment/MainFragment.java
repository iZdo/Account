...
import com.izdo.activity.IncomeDetailsActivity;
import com.izdo.MainActivity;
import com.izdo.activity.OutcomeDetailsActivity;
import com.izdo.R;
import com.izdo.adapter.DataAdapter;
...
public class MainFragment extends Fragment {
    ...
    private void setRecyclerView() {
        ...
        mDataAdapter.setOnItemLongClickListener(new DataAdapter.OnItemLongClickListener() {
            @Override
            public void onItemLongClick(View view, final int position) {
                ...
                deleteButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        // 删除记录
                        DatabaseHelper.getInstance(getContext()).delete("Data", "id=?", new String[]{mList.get(position).getId() + ""});
    ...
    private void query() {
        ...
        mCursor = DatabaseHelper.getInstance(getContext()).query("Data", null, "date=? and behavior=?", new String[]{mDate, mBehavior}, null, null, null);
    ...
    private void budget() {
        ...
        // 查询预算总额
        mCursor = DatabaseHelper.getInstance(getContext()).query("Budget", null, "date = ?", new String[]{nowMonth}, null, null, null);
        while (mCursor.moveToNext()) {
        ...
        // 查找这个月所有收入或支出
        mCursor = DatabaseHelper.getInstance(getContext()).query("Data", null, "date like ? ", new String[]{nowMonth + "%"}, null, null, null);
    ...
    private void queryFixedRecord() {
        ...
        mCursor = DatabaseHelper.getInstance(getContext()).query("FixedRecord", null, "behavior=?", new String[]{mBehavior}, null, null, null);
    ...
    private String insertFixedRecord(ContentValues values, Calendar tmp_calendar) {
        ...
        // 插入新数据
        DatabaseHelper.getInstance(getContext()).insert("Data", null, values);
        values.clear();
        return already_date;
    }
    ...
    private void updateAlreadyDate(String already_date, ContentValues values) {
        ...
        DatabaseHelper.getInstance(getContext()).update("FixedRecord", values,
