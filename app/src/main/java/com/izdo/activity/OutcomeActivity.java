...
import com.izdo.R;
import com.izdo.adapter.PagerAdapter;
...
public class OutcomeActivity extends AppCompatActivity implements View.OnClickListener {
       ...
       /* Button aaa = (Button) findViewById(R.id.aaa);
        ...
        aaa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatabaseHelper mDatabaseHelper = new DatabaseHelper(OutcomeActivity.this, "Account.db", null, 1);
    ...
    private void setViewpager() {
        ...
        mPagerAdapter = new PagerAdapter(mViewList);
